/**
 * @file gold_bus_deco.h
 *
 * @copyright 2020 Anthony Ross-Sapienza, All rights reserved.
 */

#ifndef SRC_GOLD_BUS_DECO_H_
#define SRC_GOLD_BUS_DECO_H_
 ...
 **/
class GoldBusDecorator : public BusDecorator {
 public:
    /**
     ...
     */
    explicit GoldBusDecorator(IBus * bus): BusDecorator(bus) {}
    /**
  ...
  // Vis Getters
    ...
    /**
     * @brief Set the bus color to gold
     *
     * The moment this function shines, setting the bus color to gold
     *

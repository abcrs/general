/**
 * @file maroon_bus_deco.h
 *
 * @copyright 2020 Anthony Ross-Sapienza, All rights reserved.
 */

#ifndef SRC_MAROON_BUS_DECO_H_
#define SRC_MAROON_BUS_DECO_H_
 ...
 **/
class MaroonBusDecorator : public BusDecorator {
 public:
    /**
     ...
     */
    explicit MaroonBusDecorator(IBus * bus): BusDecorator(bus) {}
    /**
  ...
  // Vis Getters
    ...
    /**
     * @brief Set the bus color to maroon
     *
     * The moment this function shines, setting the bus color to maroon
     *
     * @param[in] A struct containing the correct color or 0
     */
    void SetColor(Color n_color) override;
    /**
     ...
     */
    void SetAlpha(int a) override { bus_deco_->SetAlpha(a); }
    /**

...
public:
    ...
    void Draw(const Matrix4 &model_matrix, const Matrix4 &view_matrix, const Matrix4 &proj_matrix, bool morphing, double alpha_step);
...
protected:
    ...
    std::vector<Point3> flat_vertices_;
    std::vector<Point3> sphere_vertices_;
    std::vector<Point3> morphing_vertices_;

    std::vector<Vector3> flat_normals_;
    std::vector<Vector3> sphere_normals_;
    std::vector<Vector3> morphing_normals_;
